...
template_gen_expert_identity_spymaster = '''For each instruction, write a high-quality description about the most capable and suitable agent to answer the instruction. In second person perspective.
...
[Instruction]: Try to find a single word hint that can accurately represent and link the {n} given words: "{target_words}". The key is to select a hint that does not cause confusion with other words from the following list: {word_list}.
[Agent Description]: 
...
template_expert_prompting_spymaster = '''{expert_identity}\n\nNow given the above identity background, please answer the following instruction:\n\nTry to find a single word hint that can accurately represent and link the {n} given words: "{target_words}". The key is to select a hint that does not cause confusion with other words from the following list: {word_list}.'''

template_gen_expert_identity_guesser = '''For each instruction, write a high-quality description about the most capable and suitable agent to answer the instruction. In second person perspective.
...
[Instruction]: Try to identify the {n} words best associated with the word "{hint_word}" from the following list: {word_list}. Your answer should be a comma-separated list of words.
[Agent Description]: 
...
template_expert_prompting_guesser = '''Try to identify the {n} words best associated with the word "{hint_word}" from the following list: {word_list}. Your answer should be a comma-separated list of words.'''
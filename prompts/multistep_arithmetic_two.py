standard_prompt = '''Calculate the answer of the following mathematical formula:{task}
...
cot_prompt = '''Calculate the answer of the following mathematical formula:{task}
...
Task: Calculate the answer of the following mathematical formula: {task}
'''
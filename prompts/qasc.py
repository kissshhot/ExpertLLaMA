standard_prompt = '''Please select the correct answer to the question from the options below:
{task}
...
cot_prompt = '''Please select the correct answer to the question from the options below:
{task}
...
Task: Please select the correct answer to the question from the options below:
{task}
'''
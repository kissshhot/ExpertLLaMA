...
[Instruction]: Write a short and coherent story about {topic} that incorporates the answers to the following {n} questions: {questions}
[Agent Description]: 

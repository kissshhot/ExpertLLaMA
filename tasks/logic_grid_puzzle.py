...
from prompts.logic_grid_puzzle import standard_prompt, cot_prompt, spp_prompt, spp_prompt_profile, spp_prompt_fixed_persona, template_gen_expert_identity, template_expert_prompting
import json
...
class LogicGridPuzzleTask(Task):
    ...
    def get_input_prompt(self, idx: int, method: str, **kwargs) -> str:
        ...
        if method == "standard":
            ...
            input_prompt = template_gen_expert_identity.format(input=input_str)
        else:
    ...
    def get_input_prompt_Expertllama(self, idx: int, expert_identity: str, **kwargs) -> str:
        ...
        input_prompt = template_expert_prompting.format(input=input_str)

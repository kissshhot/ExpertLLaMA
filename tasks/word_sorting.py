...
from prompts.word_sorting import standard_prompt, cot_prompt, spp_prompt
import json
...
class word_sortingTask(Task):
    def __init__(self, file='word_sorting.jsonl'):
        super().__init__()
        path = os.path.join(DATA_PATH, 'word_sorting', file)
